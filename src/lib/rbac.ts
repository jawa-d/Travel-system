...
const permissions = {
  ...
  engineeringRequestsRead: [Role.SUPER_ADMIN, Role.ADMIN, Role.UNDERWRITER],
  engineeringRequestsManage: [Role.SUPER_ADMIN, Role.ADMIN, Role.UNDERWRITER],
  engineeringRequestsDelete: [Role.SUPER_ADMIN],
