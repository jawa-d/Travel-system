        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IssuedByRole = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    AgencyId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Policies_Agencies_AgencyId",
                        column: x => x.AgencyId,
                        principalTable: "Agencies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Policies_TravelPlans_TravelPlanId",
                        column: x => x.TravelPlanId,
                        principalTable: "TravelPlans",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Policies_Users_IssuedByUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Claims_CreatedByUserId_Status",
                table: "Claims",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Endorsements_CreatedByUserId_Status",
                table: "Endorsements",
                columns: new[] { "CreatedByUserId", "Status" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LookupValues_Category_Name",
                table: "LookupValues",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Policies_AgencyId_CreatedAt",
                table: "Policies",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Policies_IssuedByUserId_Status",
                table: "Policies",
                columns: new[] { "IssuedByUserId", "Status" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Policies_TravelPlanId",
                table: "Policies",
                column: "TravelPlanId");

            migrationBuilder.CreateIndex(
                name: "IX_PolicyCancellations_CreatedByUserId_Status",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TravelPlans_NameArabic_NameEnglish",
                table: "TravelPlans",
                columns: new[] { "NameArabic", "NameEnglish" });
